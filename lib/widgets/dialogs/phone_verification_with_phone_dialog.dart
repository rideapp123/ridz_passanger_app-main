...
class PhoneVerificationWithPhoneDialog extends StatefulWidget {
  const PhoneVerificationWithPhoneDialog({super.key});

  @override
  State<PhoneVerificationWithPhoneDialog> createState() =>
      _PhoneVerificationWithPhoneDialogState();
}

class _PhoneVerificationWithPhoneDialogState
    extends State<PhoneVerificationWithPhoneDialog> {
                        ...
                        return CustomButton(
                          ...
                          onTap: () async {
                            if (user?.mobileNumber == null ||
                              ...
                              await userStoreProvider().updateUser(
                                  UserDetailsUpdateContract(
                                      mobileNumber:
                                          '+91${UtilsHelper.removePlus91(_phoneController.text.trim())}'));
                            ...
                            if (userStoreProvider().isError == false &&
                                userStoreProvider().isVerifying == false) {
                              startTimer();
                              _nextPage();
                            }
                          },
